                      ...
                      RichText(
                        ...
                        text: TextSpan(
                          children: [
                            TextSpan(
                              text:
                                  'This app scans QR codes containing a JSON string with:  \n- `msg`: Message to sign  \n- `url`: Webhook to send the signature to \n- (Optional) `addr`: Specific address to use  \n\nFeatures:  \n- Store multiple private keys securely  \n- Select which address signs each message  \n- Instantly send signatures to any webhook  \n\nNo tracking. No servers. Just cryptographic proof.  \n\nPowered by ',
